...
/* Quiz character — goofy blob companion with quirky asymmetric faces */
const QuizBuddy = ({ step }) => {
  const expressions = [
    // Step 1: curious — eyes far apart, "o" mouth offset
    <svg key="1" viewBox="0 0 60 60" fill="none" className="w-12 h-12"><circle cx="30" cy="30" r="26" fill="#FFD23F"/><circle cx="18" cy="32" r="2.5" fill="#2D1B69"/><circle cx="38" cy="28" r="2.5" fill="#2D1B69"/><ellipse cx="26" cy="42" rx="3.5" ry="3" fill="#2D1B69" opacity="0.6"/></svg>,
    // Step 2: excited — eyes close together low, wide grin
    <svg key="2" viewBox="0 0 60 60" fill="none" className="w-12 h-12"><circle cx="30" cy="30" r="26" fill="#FF8FAB"/><circle cx="22" cy="34" r="2.5" fill="#2D1B69"/><circle cx="34" cy="32" r="2.5" fill="#2D1B69"/><path d="M18 40 C24 48, 32 48, 38 42" stroke="#2D1B69" strokeWidth="2.5" strokeLinecap="round" fill="none"/></svg>,
    // Step 3: thinking — eyes offset right, flat mouth
    <svg key="3" viewBox="0 0 60 60" fill="none" className="w-12 h-12"><circle cx="30" cy="30" r="26" fill="#B197FC"/><circle cx="32" cy="26" r="2.5" fill="#2D1B69"/><circle cx="44" cy="30" r="2.5" fill="#2D1B69"/><path d="M30 38 L42 40" stroke="#2D1B69" strokeWidth="2.5" strokeLinecap="round"/></svg>,
    // Step 4: helpful — face offset left, wonky smile
    <svg key="4" viewBox="0 0 60 60" fill="none" className="w-12 h-12"><circle cx="30" cy="30" r="26" fill="#38BDF8"/><circle cx="18" cy="30" r="2.5" fill="#2D1B69"/><circle cx="34" cy="34" r="2.5" fill="#2D1B69"/><path d="M16 38 C22 44, 30 44, 36 40" stroke="#2D1B69" strokeWidth="2.5" strokeLinecap="round" fill="none"/></svg>,
    // Step 5: ready! — squint eyes offset, big goofy grin
    <svg key="5" viewBox="0 0 60 60" fill="none" className="w-12 h-12"><circle cx="30" cy="30" r="26" fill="#22C55E"/><path d="M16 30 C17 27, 21 27, 22 30" stroke="#2D1B69" strokeWidth="2.5" strokeLinecap="round" fill="none"/><path d="M34 28 C35 25, 39 25, 40 28" stroke="#2D1B69" strokeWidth="2.5" strokeLinecap="round" fill="none"/><path d="M14 38 C22 48, 34 48, 42 40" stroke="#2D1B69" strokeWidth="2.8" strokeLinecap="round" fill="none"/></svg>,
  ]
      ...
      <section className="py-20 md:py-[6.5rem]" id="quiz" ref={sectionRef}>
        <div className="max-w-[1240px] mx-auto px-5 md:px-10">
          <div className="max-w-[660px] mx-auto bg-white rounded-[28px] shadow-[0_24px_64px_rgba(26,26,46,.1)] border-2 border-n200/40 p-8 text-center animate-[scale-pop_.5s_cubic-bezier(.4,0,.2,1)_forwards]">
            {/* Happy celebration blob — goofy face */}
            <svg viewBox="0 0 80 90" fill="none" className="w-20 h-[90px] mx-auto mb-4">
              <circle cx="40" cy="40" r="36" fill="#22C55E" />
              {/* Squint eyes — offset, different heights */}
              <path d="M22 38 C24 34, 28 34, 30 38" stroke="#2D1B69" strokeWidth="2.8" strokeLinecap="round" fill="none" />
              <path d="M44 34 C46 30, 50 30, 52 34" stroke="#2D1B69" strokeWidth="2.8" strokeLinecap="round" fill="none" />
              {/* Wide goofy grin */}
              <path d="M18 50 C28 64, 46 64, 56 52" stroke="#2D1B69" strokeWidth="3" strokeLinecap="round" fill="none" />
              {/* Tiny legs */}
              <ellipse cx="32" cy="80" rx="6" ry="8" fill="#22C55E" />
              <ellipse cx="48" cy="80" rx="6" ry="8" fill="#22C55E" />
              {/* Sparkles */}
              <path d="M14 12 C14 16, 14 16, 18 16 C14 16, 14 16, 14 20 C14 16, 14 16, 10 16 C14 16, 14 16, 14 12Z" fill="#FFD23F" />
              <path d="M64 10 C64 13, 64 13, 67 13 C64 13, 64 13, 64 16 C64 13, 64 13, 61 13 C64 13, 64 13, 64 10Z" fill="#FFD23F" />
            </svg>
